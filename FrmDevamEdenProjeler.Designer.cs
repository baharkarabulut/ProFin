namespace ProFin
{
	partial class FrmDevamEdenProjeler
	{
        ...
        series1};
			...
			this.btnPdfAktar.Click += new System.EventHandler(this.btnPdfAktar_Click_1);
			// 
			// btnExcelAktar
			// 
			...
			this.Text = "Devam Eden Projeler";
			this.Load += new System.EventHandler(this.FrmDevamEdenProjeler_Load);
